...
from base import announcement, request_and_approve, views, views_onboarding
...
urlpatterns = [
    ...
    path("company-onboarding/", views_onboarding.step1_welcome, name="company-onboarding"),
    path("company-onboarding/step1/", views_onboarding.step1_welcome, name="company-onboarding-step1"),
    path("company-onboarding/step2/", views_onboarding.step2_company, name="company-onboarding-step2"),
    path("company-onboarding/step3/", views_onboarding.step3_departments, name="company-onboarding-step3"),
    path("company-onboarding/step3/delete/<int:dept_id>/", views_onboarding.dept_delete, name="company-onboarding-dept-delete"),
    path("company-onboarding/step4/", views_onboarding.step4_positions, name="company-onboarding-step4"),
    path("company-onboarding/step4/delete/<int:pos_id>/", views_onboarding.pos_delete, name="company-onboarding-pos-delete"),
    path("company-onboarding/step5/", views_onboarding.step5_schedule, name="company-onboarding-step5"),
    path("company-onboarding/step6/", views_onboarding.step6_employee_types, name="company-onboarding-step6"),
    path("company-onboarding/step6/delete/<int:et_id>/", views_onboarding.employee_type_delete, name="company-onboarding-et-delete"),
    path("company-onboarding/step7/", views_onboarding.step7_work_types, name="company-onboarding-step7"),
    path("company-onboarding/step7/delete/<int:wt_id>/", views_onboarding.work_type_delete, name="company-onboarding-wt-delete"),
    path("company-onboarding/step8/", views_onboarding.step8_holidays, name="company-onboarding-step8"),
    path("company-onboarding/step8/delete/<int:holiday_id>/", views_onboarding.holiday_delete, name="company-onboarding-holiday-delete"),
    path("company-onboarding/step9/", views_onboarding.step9_leave_types, name="company-onboarding-step9"),
    path("company-onboarding/step9/delete/<int:lt_id>/", views_onboarding.leave_type_delete, name="company-onboarding-lt-delete"),
    path("company-onboarding/step10/", views_onboarding.step10_summary, name="company-onboarding-step10"),
    path("company-onboarding/complete/", views_onboarding.onboarding_complete, name="company-onboarding-complete"),
    path("company-onboarding/skip/", views_onboarding.onboarding_skip, name="company-onboarding-skip"),
    path("company-onboarding/dismiss-banner/", views_onboarding.onboarding_dismiss_banner, name="company-onboarding-dismiss-banner"),
