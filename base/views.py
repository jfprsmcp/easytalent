...
def login_user(request):
    ...
    if request.method == "POST":
        ...
        # Check if company needs onboarding (first login after registration)
        from base.views_onboarding import needs_onboarding
...
def home(request):
    ...
    # Check if company onboarding is pending
